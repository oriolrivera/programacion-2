...
Partial Public Class Database3DataSet
    ...
    Partial Public Class clientesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddclientesRow(ByVal nombre As String, ByVal apellido As String, ByVal telefono As Integer, ByVal direccion As String) As clientesRow
            Dim rowclientesRow As clientesRow = CType(Me.NewRow,clientesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, nombre, apellido, telefono, direccion}
        ...
        Private Sub InitClass()
            ...
            Me.columnapellido.MaxLength = 55
    ...
    Partial Public Class clientesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `clientes` SET `nombre` = ?, `apellido` = ?, `telefono` = ?, `direccion` ="& _ 
                ...
                "? = 1 AND `apellido` IS NULL) OR (`apellido` = ?)) AND ((? = 1 AND `telefono` IS"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.clientes.My.MySettings.Default.Database3ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, nombre, apellido, telefono, direccion FROM clientes"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database3DataSet.clientesDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database3DataSet.clientesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database3DataSet.clientesDataTable = New Database3DataSet.clientesDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Database3DataSet.clientesDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_nombre As String, ByVal Original_apellido As String, ByVal Original_telefono As Global.System.Nullable(Of Integer), ByVal Original_direccion As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal nombre As String, ByVal apellido As String, ByVal telefono As Global.System.Nullable(Of Integer), ByVal direccion As String) As Integer
